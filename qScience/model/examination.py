...
from qScience.model.examination_status import NewExaminationStatus, ExaminationStatus
...
class Examination(QScienceMixin, Document):
...
class ExaminationTemplate(QScienceMixin, Document):
    """
