...
import itertools
from qScience.base import QScienceMixin
...
class Permission(QScienceMixin, Document):
...
class Role(QScienceMixin, Document):
...
class User(QScienceMixin, UserMixin, Document):
