...
from qScience.tests import _get_current_patient_id
from qScience.tests.test import EasyRisAppTest
...
class ExaminationAPITest(EasyRisAppTest):
    ...
    def test_create(self):
        ...
        rv = self.app.post(path='/examination/search', 
                           data=json.dumps({'id_patient':"2016120001",
                                            "medico_richiedente":"frisco frasco"}),
                           content_type='application/json')
        response = json.loads(rv.data)
