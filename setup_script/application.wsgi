import sys
sys.stdout = sys.stderr   # print out python error to apache error.log
sys.path.insert(0, '/home/pi/') # used to bind mod_wsgi to flask app
from project import app as application # application import

############ Following lines are optional only used for extensive debug purposes #############
'''
import logging
